 ...
 * @author ADMIN
 */
public class GUI_HOME_QuanLy extends javax.swing.JFrame {
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(panelThayDoi, javax.swing.GroupLayout.DEFAULT_SIZE, 966, Short.MAX_VALUE)
    ...
    private void btnNhapVeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnNhapVeActionPerformed
        thayDoiPanelChinh(guiNhanVien, btnNhapVe);
    ...
    private void btnDatVeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDatVeActionPerformed
       thayDoiPanelChinh(guiThongKe, btnDatVe);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_HOME_QuanLy.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_HOME_QuanLy().setVisible(true);
